...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web applications with  Laravel/ ASP.Net / Reactjs / Nodejs / Django and some other cool libraries and frameworks."
  ),
  resumeLink:
